...
export default function FilterBuilder({ visibleColumns, filters, onFilterChange, onClose, onClearFilters, isSearchFromSearchBar = false, onSearchFromSearchBarChange }) {
    ...
    const getFilterKey = (field, bound) => {
        const fieldMap = {
            ...
            'buy_sell_rate_1w': 'Buy_sell_rate_1w',
            'buy_sell_rate_1m': 'Buy_sell_rate_1m',
            'buy_sell_rate_3m': 'Buy_sell_rate_3m',
            'price_5m_high': 'Price_5m_high',
            'price_5m_low': 'Price_5m_low',
            'price_1h_high': 'Price_1h_high',
            'price_1h_low': 'Price_1h_low',
            'price_6h_high': 'Price_6h_high',
            'price_6h_low': 'Price_6h_low',
            'price_24h_high': 'Price_24h_high',
            'price_24h_low': 'Price_24h_low',
            'price_1w_high': 'Price_1w_high',
            'price_1w_low': 'Price_1w_low',
            'price_1m_high': 'Price_1m_high',
            'price_1m_low': 'Price_1m_low',
            'price_3m_high': 'Price_3m_high',
            'price_3m_low': 'Price_3m_low',
            'trend_5m': 'Trend_5m',
            'trend_1h': 'Trend_1h',
            'trend_6h': 'Trend_6h',
            'trend_24h': 'Trend_24h',
